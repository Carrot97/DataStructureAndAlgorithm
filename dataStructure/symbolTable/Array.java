...
public class Array<Key extends Comparable<Key>, Value> {
    ...
    public Array() {
        key_values = new Key_Value[1];
    }

    public Array(Key[] keys, Value[] values) {
        key_values = new Key_Value[1];
        key_values[0] = new Key_Value(keys[0], values[0]);  // 此处必须先建立一个对象，否则下面put时this会指向null。
    ...
    public static void main(String[] args) {
        ...
        Array<Character, Integer> arr = new Array<>(keys, values);
